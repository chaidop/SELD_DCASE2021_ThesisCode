...
https://github.com/thomeou/SALSA/blob/90562a236117f4810a4a821b6ae165d1255650eb/utilities/transforms.py
...
########### https://github.com/TensorSpeech/TensorFlowASR/blob/caee2e79d0eb9d1a997f5df8e2ba3ee7f0a1bcae/tensorflow_asr/augmentations/methods/specaugment.py
class FreqMasking:
        ...
        if self.n_last_channels == 0:
            ...
            if direction == 'up':
                new_spec[:-self.n_last_channels] = np.pad(
                    new_spec[:-self.n_last_channels], ((0, 0), (shift_len, 0)), mode=self.mode)[:, :, 0:n_features]
            else:
                new_spec[:-self.n_last_channels] = np.pad(
